        ...
        <Link to={`/restaurant-menu/${info.link.split('/')[4]}`}>
            <div className='min-w-[295px] h-[182px] cursor-pointer duration-1000 relative overflow-hidden rounded-xl '>
                <div>
                    ...
                    <p className='absolute bottom-1 text-[#FFFFFF] text-xl ml-2 font-semibold tracking-tight' >{info?.aggregatedDiscountInfoV3 ?
            ...
            <div className='mt-3'>
                ...
                <p className='flex items-center gap-2 text-lg font-semibold' ><MdStars className='text-green-700' /> {info?.avgRating}<span>{info?.sla?.slaString}</span></p>
